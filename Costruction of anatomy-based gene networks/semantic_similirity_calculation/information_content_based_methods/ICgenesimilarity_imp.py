...
import lin_similarity as ws

'''This method use IC based methods to calculate gene similarity'''

# defining a global variable
# available types: slick    res   lin
    ...
    for i in l1:
        ...
        for j in l2:
            ...
            if i+j in dytable:
                ...
                print i, j
                simvalue = ws.icmethods(i,j,ictype)
...
out = open('slick_genenetworkfull.txt','wb+')
...
#
#icscore =ws.icmethods('uberon_0001708','uberon_0001628','res')
